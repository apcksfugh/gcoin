...
//unsigned int nTransactionsUpdated = 0x458348243a3992d189bd0c822974b0d7dda7743dc98600d9ea12f1fb7689b900;

map<uint256, CBlockIndex *> mapBlockIndex;
uint256 hashGenesisBlock("0x458348243a3992d189bd0c822974b0d7dda7743dc98600d9ea12f1fb7689b900");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Funcoin: 3.5 days   //jl
static const int64 nTargetSpacing = 5 * 60;            // Funcoin: 2.5 minutes   ///jl
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x07b3d233dab6f74ff8c8234804a3f686213cf7b654461ae0b38eb650f766b3c5");  //testnet
    }
...
bool InitBlockIndex()
{
    ...
    if (!fReindex)
    {
        ...
        // Genesis block
        const char *pszTimestamp = "Master coin and fun coin are born in 2020 no more bailouts for banks";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char *)pszTimestamp, (const unsigned char *)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN; //jl
        txNew.vout[0].scriptPubKey = CScript() << ParseHex(" 04760877f4891db251fb79c61d4b045c85bf4eacd021af8b4ec4e590430b43dc4da4d9b6562a4958c578d3ed44d5b8581fe93b5d4f698c8c1b31c92cd2c2feb41d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime = 1587588930;
        block.nBits = 0x1e0ffff0;
        block.nNonce = 2088223332;  //updated

        if (fTestNet)
        {
            block.nTime = 1587588868;
            block.nNonce = 385917283;
        }
      ...
      assert(block.hashMerkleRoot == uint256("0x761952150ea83147eff09dfb42941ac8b5612a9f6cf2aef6a4045a2e2a9f63ff"));
        block.print();
