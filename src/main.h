...
static const int64 MAX_MONEY = 350000 * COIN;  // hlaf twice, 10000*20+ 10000*10  + 10000*5  
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 10; //100 blocks.  
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 280 / 250;   //jl  amount of light coin blocks found.  rate at which foudn per dificulty period.  for 5 min. 280 fun coins mined, then dificulty adjusted.  
    }
